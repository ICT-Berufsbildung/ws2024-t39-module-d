...
Install-ADDSForest -DomainName "wsc2024.local" -DomainNetBiosName "wsc2024" -InstallDns:$true -NoRebootOnCompletion:$true -SafeModeAdministratorPassword (ConvertTo-SecureString "Skills39" -AsPlainText -Force)