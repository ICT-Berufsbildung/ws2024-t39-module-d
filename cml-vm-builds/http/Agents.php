...
class Agents extends AbstractController
{
    ...
    public function createAgentRecord(Request $request, EntityManagerInterface $entityManager, UserPasswordEncoderInterface $passwordEncoder, UserService $userService)
    {
        ...
        if (!empty($user)) {
            ...
            $encodedPassword = $passwordEncoder->encodePassword($user, $params['password']);
